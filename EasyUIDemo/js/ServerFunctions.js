...
function TServerMethods1(connectionInfo)
{
  ...
  this.FetchImage = function() {
    var returnObject = this.executor.executeMethod('FetchImage', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.FetchImage_URL = function() {
    return this.executor.getMethodURL("FetchImage", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["EchoString","ReverseString","FetchImage"]
};
